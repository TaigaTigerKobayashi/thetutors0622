...
$sql = 'UPDATE calendar_table SET STUDENT=:STUDENT,TUTOR=:TUTOR,title=:title,text=:text,way=:way,day=:day,start=:start WHERE id=:id';
...
$stmt->bindValue(':way', $way, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
